...
namespace HotelAPI.Migrations
{
    ...
    [Migration("20250418042700_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelAPI.Data.ApDungKm", b =>
                {
            ...
            modelBuilder.Entity("HotelAPI.Data.BaoCaoDoanhThu", b =>
                {
            ...
            modelBuilder.Entity("HotelAPI.Data.CaLamViec", b =>
                {
            ...
            modelBuilder.Entity("HotelAPI.Data.ChiTietDatPhong", b =>
                {
            ...
            modelBuilder.Entity("HotelAPI.Data.DanhGium", b =>
                {
            ...
            modelBuilder.Entity("HotelAPI.Data.DatPhong", b =>
                {
                    b.Property<string>("MaDatPhong")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("HotelAPI.Data.DichVu", b =>
                {
            ...
            modelBuilder.Entity("HotelAPI.Data.HoaDon", b =>
                {
            ...
            modelBuilder.Entity("HotelAPI.Data.KhachHang", b =>
                {
                    b.Property<string>("MaKh")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("HotelAPI.Data.KhuyenMai", b =>
                {
                    b.Property<string>("MaKm")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("HotelAPI.Data.LoaiKhachHang", b =>
                {
                    b.Property<string>("MaLoaiKh")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("HotelAPI.Data.LoaiPhong", b =>
                {
                    b.Property<string>("MaLoaiPhong")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("HotelAPI.Data.NhanVien", b =>
                {
                    b.Property<string>("MaNv")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("HotelAPI.Data.PhanQuyen", b =>
                {
            ...
            modelBuilder.Entity("HotelAPI.Data.Phong", b =>
                {
                    b.Property<string>("MaPhong")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("HotelAPI.Data.PhuongThucThanhToan", b =>
                {
            ...
            modelBuilder.Entity("HotelAPI.Data.Role", b =>
                {
                    b.Property<string>("MaRole")
                        .HasMaxLength(10)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("HotelAPI.Data.SuDungDichVu", b =>
                {
            ...
            modelBuilder.Entity("HotelAPI.Data.ApDungKm", b =>
                {
                    b.HasOne("HotelAPI.Data.DatPhong", "MaDatPhongNavigation")
                        .WithMany("ApDungKms")
                        .HasForeignKey("MaDatPhong")
                        .IsRequired()
                        .HasConstraintName("FK_ApDungKM_DatPhong");

                    b.HasOne("HotelAPI.Data.KhuyenMai", "MaKmNavigation")
                        .WithMany("ApDungKms")
                        .HasForeignKey("MaKm")
                        .IsRequired()
            ...
            modelBuilder.Entity("HotelAPI.Data.BaoCaoDoanhThu", b =>
                {
                    b.HasOne("HotelAPI.Data.NhanVien", "MaNvNavigation")
            ...
            modelBuilder.Entity("HotelAPI.Data.ChiTietDatPhong", b =>
                {
                    ...
                    b.HasOne("HotelAPI.Data.LoaiPhong", "MaLoaiPhongNavigation")
                        .WithMany("ChiTietDatPhongs")
                        .HasForeignKey("MaLoaiPhong")
                        .IsRequired()
                        .HasConstraintName("FK_ChiTietDatPhong_LoaiPhong");

                    b.HasOne("HotelAPI.Data.Phong", "MaPhongNavigation")
                        .WithMany("ChiTietDatPhongs")
            ...
            modelBuilder.Entity("HotelAPI.Data.DatPhong", b =>
                {
                    b.HasOne("HotelAPI.Data.KhachHang", "MaKhNavigation")
                        .WithMany("DatPhongs")
                        .HasForeignKey("MaKh")
            ...
            modelBuilder.Entity("HotelAPI.Data.KhachHang", b =>
                {
                    b.HasOne("HotelAPI.Data.LoaiKhachHang", "MaLoaiKhNavigation")
                        .WithMany("KhachHangs")
            ...
            modelBuilder.Entity("HotelAPI.Data.NhanVien", b =>
                {
                    b.HasOne("HotelAPI.Data.CaLamViec", "MaCaLamNavigation")
                        .WithMany("NhanViens")
            ...
            modelBuilder.Entity("HotelAPI.Data.PhanQuyen", b =>
                {
                    ...
                    b.HasOne("HotelAPI.Data.Role", "MaRoleNavigation")
                        .WithOne("PhanQuyen")
                        .HasForeignKey("HotelAPI.Data.PhanQuyen", "MaRole")
                        .IsRequired()
            ...
            modelBuilder.Entity("HotelAPI.Data.PhuongThucThanhToan", b =>
                {
                    b.HasOne("HotelAPI.Data.HoaDon", "MaHoaDonNavigation")
            ...
            modelBuilder.Entity("HotelAPI.Data.SuDungDichVu", b =>
                {
                    ...
                    b.HasOne("HotelAPI.Data.DichVu", "MaDichVuNavigation")
                        .WithMany("SuDungDichVus")
